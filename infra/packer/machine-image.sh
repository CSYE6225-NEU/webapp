...
# STORAGE_IMAGE_NAME="webapp-nodejs-mysql-1740455384"     # The source image to use
# TEMP_INSTANCE_NAME="webapp-nodejs-temp-vm"              # Name for temporary VM
# MACHINE_IMAGE_NAME="webapp-nodejs-mysql-machine-image"  # Name for the output machine image
